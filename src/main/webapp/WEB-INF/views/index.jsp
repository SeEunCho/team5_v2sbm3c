...
<body>
  ...
  <jsp:include page="/WEB-INF/views/menu/top.jsp" flush='false' />
    ...
    <DIV class='title_line'> 서울시 아파트 거래정보 제공 서비스  </DIV>
     ...
     <c:choose>
       ...
       <c:otherwise>
         <div class="container" style="text-align: center;"><h3> 구해줘! 홈즈는 공공데이터 포털에서 받아 온 실제 부동산거래 데이터를 기반으로 제작하였습니다.</h3></div>
         <div class="container" style="text-align: center;"> <span style="font-size: small;"><b>아래의 입력란을 통해 부동산 시세정보를 지금 확인해보세요!</b></span></div><br>
       </c:otherwise>
     </c:choose>
