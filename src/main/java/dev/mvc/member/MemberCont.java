...
//     }
     ...
     * @throws Exception 
     ...
     /**
      * 목록 + 검색 + 페이징 지원
      * http://localhost:9090/member/list_by_search_paging.do?word=user&now_page=1
      * 
      * @param cateno
      * @param word
      * @param now_page
      * @return
      */
     @RequestMapping(value = "/member/list_by_search_paging.do", method = RequestMethod.GET)
     public ModelAndView list_by_cateno_search_paging(@RequestParam(value = "word", defaultValue = "") String word,
       ...
       // 검색 목록
       List<MemberVO> list = memberProc.list_by_search_paging(map);
       mav.addObject("list", list);
        ...
        * @return 페이징 생성 문자열
        */
       String paging = memberProc.pagingBox(search_count, now_page, word);
       mav.addObject("paging", paging);

       mav.addObject("now_page", now_page);

       // /member/list_by_search_paging.jsp
       mav.setViewName("/member/list_by_search_paging");
